    ...
    >
      ...
      >
        ...
        >
          ...
          <p className="text-muted" style={{ margin: '0 0 18px', fontSize: 14, lineHeight: 1.5 }}>
            {t('auth.sub')}
          </p>
          ...
          {!isAppleEnabled && !notConfigured && (
            <span className="text-muted" style={{ fontSize: 12.5, textAlign: 'center' }}>
              {t('auth.appleSoon')}
            </span>
          )}
          ...
          {signInError && (
            ...
            >
              <span style={{ fontSize: 14 }}>{t('auth.errorTitle')}</span>
              <span className="text-muted" style={{ fontSize: 12.5, lineHeight: 1.5 }}>
                {signInError[language]}
              </span>
              <Button variant="ghost" onClick={clearSignInError} alignSelf="center" fontSize={13}>
                {t('auth.retry')}
              </Button>
            </div>
          )}
