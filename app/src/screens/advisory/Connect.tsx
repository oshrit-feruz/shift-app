            ...
            return (
              ...
              >
                ...
                <span style={{ flex: 1, minWidth: 0 }}>
                  <span style={{ display: 'block', fontSize: 17, fontWeight: 600 }}>{b.name}</span>
                  <span className="text-muted" style={{ display: 'block', fontSize: 15.5, lineHeight: 1.45 }}>
                    {b.help[language]}
                  </span>
                </span>
                <span style={{ color: 'var(--color-accent)', fontSize: 17 }}>{selected ? '✓' : ''}</span>
              </button>
            );
          })}
        </div>
