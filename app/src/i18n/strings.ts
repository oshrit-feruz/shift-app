...
export const STRINGS = {
  ...
  'rec.dailyTag': p('Updated daily', 'מתעדכן כל יום'),
  'rec.satHelp': p(
  ...
  'rec.updatedDaily': p(
    'This list is rebuilt every trading day from the rules above, so names come and go. It is a starting point for your own decision, not an instruction.',
    'הרשימה נבנית מחדש בכל יום מסחר לפי הכללים שלמעלה, ולכן שמות נכנסים ויוצאים. זו נקודת פתיחה להחלטה שלך, לא הוראה.',
  ),
  'rec.satInfoOnly': p(
    'Information only — your profile has no individual stocks, so these are not part of your recommendation.',
    'מידע בלבד — בפרופיל שלך אין מניות בודדות, ולכן אלה לא חלק מההמלצה שלך.',
  ),
  ...
  'stock.checkedDaily': p(
    'Checked again every trading day, so this can change tomorrow.',
    'נבדק מחדש בכל יום מסחר, ולכן זה יכול להשתנות מחר.',
  ),
  ...
  'stock.notRanked': p(
    'This stock is not among the candidates checked today. The list is rebuilt every trading day.',
    'המניה הזו אינה בין המועמדות שנבדקו היום. הרשימה נבנית מחדש בכל יום מסחר.',
  ),
