...
export const STRINGS = {
  ...
  'adv.profileMissingBody': p(
    ...
    'ההמלצה נבנית אך ורק מתשובות השאלון, והתשובות שלך חסרות. עני על ארבע השאלות והפרופיל יחושב לפי אותם כללים קבועים לכל לקוחה — שום דבר לא מונח במקומך.',
  ),
  'adv.profileMissingCta': p('Back to the questionnaire', 'חזרה לשאלון'),
  'rec.noPositions': p('No open positions right now', 'אין פוזיציות פתוחות כרגע'),
  'rec.entry': p('entry', 'כניסה'),
  ...
  'pf.name': p('Name', 'שם'),
  'pf.txLog': p('Your logged transactions', 'התנועות שרשמת'),
  'pf.txEmpty': p('No transactions logged yet', 'עוד לא נרשמו תנועות'),
  ...
  'tour.done': p('Done — to first steps', 'סיימתי — לצעדים הראשונים'),
